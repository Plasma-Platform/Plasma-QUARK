...
function connectNotificationTextField(Component) {
  ...
  return _temp = _class = function (_React$Component) {
    ...
    function TextFieldNotification(props, context) {
      (0, _classCallCheck3.default)(this, TextFieldNotification);

      var _this = (0, _possibleConstructorReturn3.default)(this, (TextFieldNotification.__proto__ || (0, _getPrototypeOf2.default)(TextFieldNotification)).call(this, props, context));

      _this.handleChange = function (event) {
        if (_this.props.onChange) _this.props.onChange(event);

        _this.input.hideNotification();
      };
      ...
      _this.component = _this.component || (0, _.connectNotificationTrigger)(Component);
      return _this;
    }
