    ...
    function NotificationTrigger(props, context) {
      ...
      _this.showNotification = function () {
        if (!_this.popup) {
          ...
          var preparedNotification = _this.props.popover ? (0, _.preparePopover)(_this.props.popover, _this.hideNotification) : (0, _.prepareNotification)(_this.props.notification, _this.hideNotification);
      ...
      _this.handleClosePopover = function (e) {
        var clickTarget = e.target.getAttribute('class');
        if (clickTarget === 'TMUI__Notification__closeBlock__closeArea' && _this.state.notification) {
          e.stopPropagation();
      ...
      _this.rerenderNotice = function (newCode) {
        ...
        var newTooltip = (0, _.prepareNotification)({ code: newCode || _this.originalCode, text: text, maxWidth: maxWidth }, _this.hideNotification);
