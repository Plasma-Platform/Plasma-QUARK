  ...
  return _temp = _class = function (_React$Component) {
    ...
    function NotificationTrigger(props, context) {
      ...
      _this.handleClosePopover = function (e) {
        ...
        if (clickTarget === 'notification__closeBlock__closeArea' && _this.state.notification) {
          e.stopPropagation();
      ...
      _this.rerenderNotice = function (newCode) {
        ...
        var text = _this$props$notificat.text;
        var maxWidth = _this$props$notificat.maxWidth;
