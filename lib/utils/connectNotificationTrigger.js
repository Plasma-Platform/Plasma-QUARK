  ...
  return _temp = _class = function (_React$Component) {
    ...
    (0, _createClass3.default)(NotificationTrigger, [{
      ...
      value: function calcNotificationCoords(targetCoords) {
        var position = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.notification.props.position;
        ...
        var rightOffSet = windowWidth - notification.getBoundingClientRect().right;
        switch (position) {
          case 'left':
    ...
    this.rerenderNotice = function (newCode) {
      ...
      var code = _props$notification.code;
      var text = _props$notification.text;
      var maxWidth = _props$notification.maxWidth;
