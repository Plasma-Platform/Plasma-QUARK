    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.defaultRating != this.props.defaultRating) {
        this.setState({
          ...
          console.log('this.state.value', _this2.state.value);
        });
      }
    }
  }]);
        ...
        _react2.default.createElement(
          ...
          (0, _from2.default)({ length: starsLength }).map(function (value, i) {
            ...
            return _react2.default.createElement('i', {
              key: i,
              className: 'stars-rating__icon ' + _this3.printStarClass(_this3.state.value, i),
              onClick: _this3.select.bind(_this3, i)
            });
          })
        )
      );
