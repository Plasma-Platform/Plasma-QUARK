...
var Switcher = function (_React$Component) {
  ...
  function Switcher(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Switcher.__proto__ || (0, _getPrototypeOf2.default)(Switcher)).call(this, props));
  ...
  (0, _createClass3.default)(Switcher, [{
    ...
    value: function render() {
      ...
      var props = (0, _objectWithoutProperties3.default)(_props, ['size', 'className', 'id', 'name', 'label', 'checked', 'tabIndex', 'onKeyUp']);
