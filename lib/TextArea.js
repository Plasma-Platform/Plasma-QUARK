...
var TextArea = function (_Component) {
  ...
  (0, _createClass3.default)(TextArea, [{
    ...
    value: function render() {
      ...
      var textAreaWrapClassname = (0, _classnames2.default)('abstract-field text-area text-area_' + this.props.sizeType.toLowerCase(), this.props.className, {
      ...
      var iconClassname = (0, _classnames2.default)('text-area__type-icon', 'icon', {
        'icon-letter': this.props.type === 'email',
        'icon-magnifier': this.props.type === 'search',
        'icon-eye': this.props.type === 'password'
      });

      var iconNotificationClassname = (0, _classnames2.default)('text-area__notification-icon', 'icon', {
