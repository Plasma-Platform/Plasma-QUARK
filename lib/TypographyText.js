...
var TypographyText = function (_Component) {
    ...
    (0, _createClass3.default)(TypographyText, [{
        ...
        value: function render() {
            ...
            }, (0, _defineProperty3.default)(_classnames, 'TMUI__TypographyText--' + this.props.type, true), (0, _defineProperty3.default)(_classnames, 'TMUI__TypographyText--' + this.props.size, true), (0, _defineProperty3.default)(_classnames, this.props.className, this.props.className), _classnames));
...
TypographyText.propTypes = {
    ...
    children: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.array, _react.PropTypes.object]),
