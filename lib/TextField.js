...
var TextField = function (_Component2) {
  ...
  function TextField(props) {
    ...
    _this2.changeFieldType = _this2.props.changeFieldType;
    return _this2;
  }

  (0, _createClass3.default)(TextField, [{
    key: 'showTooltip',
    value: function showTooltip(callback) {
    ...
    value: function hidePasswordAndTooltip(callback) {
        ...
        isPassword ? _react2.default.createElement(
          ...
          _react2.default.createElement(EyePasswordIndicatorWrapper, {
            ...
            onMouseOver: function onMouseOver() {
              _this3.showTooltip(_this3.icon.showNotification());
            },
            onMouseLeave: function onMouseLeave() {
              _this3.hidePasswordAndTooltip(_this3.icon.hideNotification());
            },
