...
var EyePasswordIndicator = exports.EyePasswordIndicator = function (_Component) {
  ...
  (0, _createClass3.default)(EyePasswordIndicator, [{
    ...
    value: function render() {
      var usedProps = (0, _assign2.default)({}, this.props);
      /** removing all the unused props so as not ot get warning in console **/
      ['notification', 'notificationAlt', 'handleHideNotification', 'closeOnCLickOutside'].map(function (e) {
        return delete usedProps[e];
      });
      return _react2.default.createElement('span', (0, _extends3.default)({}, usedProps, {
...
var TextField = function (_Component2) {
  ...
  function TextField(props) {
    ...
    var _this2 = (0, _possibleConstructorReturn3.default)(this, (TextField.__proto__ || (0, _getPrototypeOf2.default)(TextField)).call(this, props));
  ...
  (0, _createClass3.default)(TextField, [{
    ...
    value: function hidePasswordAndTooltip(e) {
      var _this4 = this;
      ...
      setTimeout(function () {
        _this4.icon.hideNotification(e.persist(), true);
      }, 100);
