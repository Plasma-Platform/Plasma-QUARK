...
var AbstractField = function (_Component) {
  (0, _inherits3.default)(AbstractField, _Component);

  function AbstractField(props, context) {
    (0, _classCallCheck3.default)(this, AbstractField);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AbstractField.__proto__ || (0, _getPrototypeOf2.default)(AbstractField)).call(this, props, context));
  ...
  (0, _createClass3.default)(AbstractField, [{
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(DecoratedTextField, (0, _extends3.default)({}, this.props, {
        ...
        notification: { code: this.props.notificationType,
...
AbstractField.propTypes = {
  ...
  sizeType: _react.PropTypes.string,
  ...
  increaseValue: _react.PropTypes.bool
};
