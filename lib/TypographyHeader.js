...
var TypographyHeader = function (_Component) {
  ...
  (0, _createClass3.default)(TypographyHeader, [{
    ...
    value: function render() {
      ...
      }, (0, _defineProperty3.default)(_classnames, 'TMUI__TypographyHeader--' + this.props.size, true), (0, _defineProperty3.default)(_classnames, this.props.className, this.props.className), _classnames));
