...
var Avatar = function (_React$Component) {
  ...
  (0, _createClass3.default)(Avatar, [{
    key: 'isNewSrc',
    value: function isNewSrc() {
      return this.props.src !== this.initialSrc;
    }
  }, {
    key: 'isNewEmail',
    value: function isNewEmail() {
    ...
    value: function render() {
      return this.state.isImgLoaded === true || this.isNewSrc() || this.isNewEmail() ? this.renderAvatarImgBySrc() : this.renderAvatarImgByInitials();
    }
  }]);
  return Avatar;
