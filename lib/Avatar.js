...
var Avatar = function (_React$Component) {
  ...
  function Avatar(props) {
    ...
    _this.state = {
      ...
      avatarBg: _this.bgColors[Math.floor(Math.random() * 10 + 1)]
    };
    ...
    _this.avatarClassName = 'avatar' + (_this.props.isRounded ? ' avatar_round' : '') + (_this.props.className ? ' ' + _this.props.className : '');
    return _this;
  }
