...
var Notification = function (_Component) {
  ...
  (0, _createClass3.default)(Notification, [{
    ...
    value: function render() {
      ...
      if (!(0, _isEmptyObject.isEmptyObject)(this.props.button)) {
        var _Button = _buttons2.default[this.props.button.code ? this.props.button.code : 'B2J'];
        var _buttonAttr = {
        ...
        if (this.props.button.id) {
          _buttonAttr.id = this.props.button.id;
        }
      } else {
        var _Button2 = null;
      }
