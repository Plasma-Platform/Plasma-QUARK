...
var Button = function (_React$Component) {
  ...
  (0, _createClass3.default)(Button, [{
    ...
    value: function render() {
      ...
      var props = (0, _objectWithoutProperties3.default)(_props, ['widthType', 'heightType', 'roundedType', 'bgType', 'icon', 'className', 'type', 'isLoading']);
      ...
      var buttonClassName = 'button' + widthClassName + heightClassName + roundClassName + bgClassName + iconClassName + loadingClassName + addClassName;
      var iconClassName = icon ? ' button__icon icon icon-' + icon : '';
