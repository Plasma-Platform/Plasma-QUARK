...
var Dropdown = function (_React$Component) {
  ...
  (0, _createClass3.default)(Dropdown, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var newSelectedOption = nextProps.options.filter(function (optionData) {
        return optionData.value === _this7.state.value || optionData.value === nextProps.defaultValue;
        ...
        this.state.open && _react2.default.createElement(
          ...
          this.props.showFilterBox && _react2.default.createElement(
            ...
            _react2.default.createElement('input', {
              ...
              onChange: function onChange(event) {
                _this8.filterOptions(event.target.value);
              },
              onKeyDown: this.handleFilterInputKeyDown,
              ref: function ref(_ref5) {
                _this8.filterInput = _ref5;
              },
              autoFocus: true
            })
          ),
          _react2.default.createElement(
            ...
            visibleOptions.length > 0 ? visibleOptions.map(function (option, index) {
              ...
              var optionIcon = _this8.props.optionIconRadioStyle ? 'tm-quark-dropdown__icon tm-quark-dropdown__icon_size_medium tm-quark-dropdown__icon_type_radio' : option.icon ? 'tm-quark-dropdown__icon tm-quark-dropdown__icon_size_' + _this8.props.optionIconSize + ' ' + ('icon icon-' + option.icon) : '';

              return _react2.default.createElement(
                'li',
                {
                  className: 'tm-quark-dropdown__option ' + (option.disabled ? 'tm-quark-dropdown__option_disabled ' : '') + 'tm-quark-dropdown__option_size_' + _this8.props.optionSize + (option.value === _this8.state.value ? ' tm-quark-dropdown__option_selected' : ''),
                  tabIndex: option.disabled || _this8.state.open === false ? -1 : 0,
                  role: 'option',
                  onClick: function onClick(event) {
                    _this8.selectOption(option);
                  },
                  onKeyDown: function onKeyDown(event) {
                    _this8.handleOptionKeyDown(event, option, optionIndex);
                  },
                  ref: function ref(_ref7) {
                    _this8['option' + optionIndex] = _ref7;
                  },
                  key: index
                },
