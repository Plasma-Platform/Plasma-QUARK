...
var Dropdown = function (_React$Component) {
  ...
  function Dropdown(props) {
    ...
    _this.handleShowContentAnimationEnd = _this.handleShowContentAnimationEnd.bind(_this);
    _this.handleHideContentAnimationEnd = _this.handleHideContentAnimationEnd.bind(_this);
    ...
    _this.openContentPosition = 'bottom';
    _this.optionsListMaxHeight = '100%';
    _this.showOptionsListScrollBar = false;
    return _this;
  }
  ...
  (0, _createClass3.default)(Dropdown, [{
    ...
    key: 'handleShowContentAnimationEnd',
    value: function handleShowContentAnimationEnd() {
    ...
    key: 'handleHideContentAnimationEnd',
    value: function handleHideContentAnimationEnd() {
      this.button.blur();
    ...
    value: function render() {
      ...
      var visibleOptions = this.props.showSelectedOption ? filteredOptions : filteredOptions.filter(function (option) {
        return option.value !== _this3.currentValue;
      });
      ...
      return _react2.default.createElement(
        ...
        this.props.showButton && _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            { className: 'tm-quark-dropdown__button-inner' },
            ...
            this.props.buttonContent ? _react2.default.createElement(
              ...
              _react2.default.createElement(
                'span',
                { className: 'tm-quark-dropdown__button-label-content' },
        ...
        this.state.open && _react2.default.createElement(
          'div',
          {
            ...
            onAnimationEnd: function onAnimationEnd() {
              _this3.state.showContent ? _this3.handleShowContentAnimationEnd() : _this3.handleHideContentAnimationEnd();
            },
            ref: function ref(_ref8) {
              _this3.content = _ref8;
            }
          },
          this.props.showFilterBox && _react2.default.createElement(
            ...
            _react2.default.createElement('input', {
              ...
              onChange: function onChange(event) {
                _this3.filterOptions(event.target.value);
              },
              onKeyDown: this.handleFilterInputKeyDown,
              ref: function ref(_ref4) {
                _this3.filterInput = _ref4;
              },
              autoFocus: true
            })
          ),
          _react2.default.createElement(
            ...
            visibleOptions.length > 0 ? visibleOptions.map(function (option, index) {
              ...
              var optionIcon = _this3.props.optionIconRadioStyle ? 'tm-quark-dropdown__icon tm-quark-dropdown__icon_size_medium tm-quark-dropdown__icon_type_radio' : option.icon ? 'tm-quark-dropdown__icon tm-quark-dropdown__icon_size_' + _this3.props.optionIconSize + ' ' + ('icon icon-' + option.icon) : '';

              return _react2.default.createElement(
                'li',
                {
                  className: 'tm-quark-dropdown__option ' + (option.disabled ? 'tm-quark-dropdown__option_disabled ' : '') + 'tm-quark-dropdown__option_size_' + _this3.props.optionSize + (option.value === _this3.currentValue && _this3.props.highlightSelectedOption ? ' tm-quark-dropdown__option_selected' : ''),
                  tabIndex: option.disabled || _this3.state.showContent === false ? -1 : 0,
                  role: 'option',
                  onClick: function onClick(event) {
                    _this3.handleOptionSelect(option);
                  },
                  onKeyDown: function onKeyDown(event) {
                    _this3.handleOptionKeyDown(event, option, optionIndex);
                  },
                  ref: function ref(_ref6) {
                    _this3['option' + optionIndex] = _ref6;
                  },
                  key: index
                },
...
Dropdown.propTypes = {
  ...
  closeOnClickOutside: _react2.default.PropTypes.bool,
