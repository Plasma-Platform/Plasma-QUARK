...
var Dropdown = function (_React$Component) {
  ...
  function Dropdown(props) {
    ...
    _this.calculateContentPosition = _this.calculateContentPosition.bind(_this);
  ...
  (0, _createClass3.default)(Dropdown, [{
    ...
    key: 'calculateContentPosition',
    value: function calculateContentPosition() {
    ...
    value: function render() {
      ...
      var contentPos = this.calculateContentPosition();
      var contentPosClassName = ' dropdown_content-position_' + contentPos;
