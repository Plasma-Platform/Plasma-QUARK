...
var Dropdown = function (_React$Component) {
  ...
  function Dropdown(props) {
    ...
    _this.state = {
      ...
      selectedOption: _this.props.defaultValue ? _this.getOptionByValue(_this.props.defaultValue) : _this.props.options[0]
    };
  ...
  (0, _createClass3.default)(Dropdown, [{
    ...
    value: function handleCloseAnimationEnd() {
      ...
      this.setState({
        ...
        if (_this3.props.onClose) {
          _this3.props.onClose(_this3.state.value);
        }
      });
    }
  }, {
    ...
    value: function getVisibleOptions() {
      ...
      var visibleOptions = this.props.options.filter(function (option) {
        return option.label.toLowerCase().search(filterQuery) >= 0 && (_this4.props.showSelectedOption ? true : _this4.state.value !== option.value);
      });
    ...
    value: function selectOption(option) {
      ...
      this.setState({
        ...
        if (_this5.props.onChange) {
          _this5.props.onChange(_this5.state.value);
        }
        _this5.close();
      });
    }
      ...
      return _react2.default.createElement(
        ...
        this.props.showButton && _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.state.selectedOption.icon && this.props.optionIconRadioStyle !== true && _react2.default.createElement('i', { className: 'tm-quark-dropdown__icon tm-quark-dropdown__icon_size_medium icon icon-' + this.state.selectedOption.icon }),
        ...
        this.state.open && _react2.default.createElement(
          ...
          this.props.showFilterBox && _react2.default.createElement(
            ...
            _react2.default.createElement('input', {
              ...
              onChange: function onChange(event) {
                _this6.filterOptions(event.target.value);
              },
              onKeyDown: this.handleFilterInputKeyDown,
              ref: function ref(_ref5) {
                _this6.filterInput = _ref5;
              },
              autoFocus: true
            })
          ),
          _react2.default.createElement(
            ...
            visibleOptions.length > 0 ? visibleOptions.map(function (option, index) {
              ...
              var optionIcon = _this6.props.optionIconRadioStyle ? 'tm-quark-dropdown__icon tm-quark-dropdown__icon_size_medium tm-quark-dropdown__icon_type_radio' : option.icon ? 'tm-quark-dropdown__icon tm-quark-dropdown__icon_size_' + _this6.props.optionIconSize + ' ' + ('icon icon-' + option.icon) : '';

              return _react2.default.createElement(
                'li',
                {
                  className: 'tm-quark-dropdown__option ' + (option.disabled ? 'tm-quark-dropdown__option_disabled ' : '') + 'tm-quark-dropdown__option_size_' + _this6.props.optionSize + (option.value === _this6.state.value ? ' tm-quark-dropdown__option_selected' : ''),
                  tabIndex: option.disabled || _this6.state.open === false ? -1 : 0,
                  role: 'option',
                  onClick: function onClick(event) {
                    _this6.selectOption(option);
                  },
                  onKeyDown: function onKeyDown(event) {
                    _this6.handleOptionKeyDown(event, option, optionIndex);
                  },
                  ref: function ref(_ref7) {
                    _this6['option' + optionIndex] = _ref7;
                  },
                  key: index
                },
