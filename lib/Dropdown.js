...
var Dropdown = function (_React$Component) {
  ...
  function Dropdown(props) {
    ...
    _this.handleShowAnimationEnd = _this.handleShowAnimationEnd.bind(_this);
    _this.close = _this.close.bind(_this);
    _this.handleHideAnimationEnd = _this.handleHideAnimationEnd.bind(_this);
  ...
  (0, _createClass3.default)(Dropdown, [{
    ...
    key: 'handleShowAnimationEnd',
    value: function handleShowAnimationEnd() {
    ...
    value: function close() {
      ...
      this.setState({
        ...
        window.removeEventListener('click', _this2.handleDropdownBlur);
        window.removeEventListener('keydown', _this2.handleDropdownBlur);
      });
    }
  }, {
    key: 'handleHideAnimationEnd',
    value: function handleHideAnimationEnd() {
    ...
    value: function getOptionsListMaxHeight() {
      ...
      options.slice(0, lastVisibleOptionIndex + 1).forEach(function (option, optionIndex) {
        optionsListHeight += lastVisibleOptionIndex === optionIndex && options.length > _this3.props.optionsToShow ? option.offsetHeight / 2 : option.offsetHeight;
      });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          className: 'tm-quark-dropdown tm-quark-dropdown_open-position_' + this.openContentPosition + ' tm-quark-dropdown_' + (this.state.open ? 'open' : 'closed') + ' tm-quark-dropdown_type_' + this.props.type + (this.props.disabled ? ' tm-quark-dropdown_disabled' : '') + ' ' + (this.props.className || ''),
