  ...
  (0, _createClass3.default)(Dropdown, [{
    ...
    value: function getVisibleOptions() {
      ...
      var visibleOptions = this.props.options.filter(function (option) {
        return option.label.search(filterQueryRegExp) >= 0 && (_this4.props.showSelectedOption ? true : _this4.props.value !== option.value);
      });
    ...
    value: function render() {
      ...
      var selectedOption = this.props.value && this.getOptionByValue(this.props.value) ? this.getOptionByValue(this.props.value) : this.valueInput && this.getOptionByValue(this.valueInput.value) ? this.getOptionByValue(this.valueInput.value) : this.defaultSelectedOption;
        ...
        this.state.open && _react2.default.createElement(
          ...
          this.props.showFilterBox && _react2.default.createElement(
            ...
            _react2.default.createElement('input', {
              ...
              onChange: function onChange(event) {
                _this5.filterOptions(event.target.value);
              },
              onKeyDown: this.handleFilterInputKeyDown,
              ref: function ref(_ref5) {
                _this5.filterInput = _ref5;
              },
              autoFocus: true
            })
          ),
          _react2.default.createElement(
            ...
            visibleOptions.length > 0 ? visibleOptions.map(function (option, index) {
              ...
              var optionIcon = _this5.props.optionIconRadioStyle ? 'tm-quark-dropdown__icon tm-quark-dropdown__icon_size_medium tm-quark-dropdown__icon_type_radio' : option.icon ? 'tm-quark-dropdown__icon tm-quark-dropdown__icon_size_' + _this5.props.optionIconSize + ' ' + ('icon icon-' + option.icon) : '';

              return _react2.default.createElement(
                'li',
                {
                  className: 'tm-quark-dropdown__option ' + (option.disabled ? 'tm-quark-dropdown__option_disabled ' : '') + 'tm-quark-dropdown__option_size_' + _this5.props.optionSize + (option.value === currentValue && _this5.props.highlightSelectedOption ? ' tm-quark-dropdown__option_selected' : ''),
                  tabIndex: option.disabled || _this5.state.open === false ? -1 : 0,
                  role: 'option',
                  onClick: function onClick(event) {
                    _this5.handleOptionSelect(option);
                  },
                  onKeyDown: function onKeyDown(event) {
                    _this5.handleOptionKeyDown(event, option, optionIndex);
                  },
                  ref: function ref(_ref7) {
                    _this5['option' + optionIndex] = _ref7;
                  },
                  key: index
                },
