  ...
  (0, _createClass3.default)(Dropdown, [{
    ...
    value: function open() {
      ...
      this.setState({
        ...
        if (_this2.props.onOpen) {
          _this2.props.onOpen(_this2.getValue());
        }
      });
    }
  }, {
    ...
    value: function handleCloseAnimationEnd() {
      ...
      this.setState({
        ...
        if (_this4.props.onClose) {
          _this4.props.onClose(_this4.getValue());
        }
      });
    }
  }, {
    ...
    value: function getVisibleOptions() {
      ...
      var visibleOptions = this.props.options.filter(function (option) {
        return option.label.search(filterQueryRegExp) >= 0 && (_this5.props.showSelectedOption ? true : _this5.props.value !== option.value);
      });
    ...
    value: function render() {
      ...
      var selectedOption = this.getOptionByValue(this.props.value);
      var currentValue = this.props.value || this.props.options[0].value;
          ...
          _react2.default.createElement(
            ...
            visibleOptions.length > 0 ? visibleOptions.map(function (option, index) {
              ...
              return _react2.default.createElement(
                'li',
                {
                  className: 'tm-quark-dropdown__option ' + (option.disabled ? 'tm-quark-dropdown__option_disabled ' : '') + 'tm-quark-dropdown__option_size_' + _this6.props.optionSize + (option.value === currentValue ? ' tm-quark-dropdown__option_selected' : ''),
                  tabIndex: option.disabled || _this6.state.open === false ? -1 : 0,
                  role: 'option',
                  onClick: function onClick(event) {
                    _this6.handleOptionSelect(option);
                  },
