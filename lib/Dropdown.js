...
var Dropdown = function (_React$Component) {
  ...
  (0, _createClass3.default)(Dropdown, [{
    ...
    value: function renderOptions() {
      ...
      var enabledOptionIndex = -1;
      var disabledOptionIndex = 0;

      return this.props.options.map(function (option) {
        var isSelectedOption = _this6.props.type !== 3 && option.value === _this6.state.value;
        var isRespondToSearch = filterQuery.length > 0 ? option.label.toLowerCase().indexOf(filterQuery) === 0 : true;
        ...
        var optionIndex = option.disabled ? disabledOptionIndex : enabledOptionIndex;
