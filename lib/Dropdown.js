          ...
          _react2.default.createElement(
            ...
            visibleOptions.length > 0 ? visibleOptions.map(function (option, index) {
              ...
              return _react2.default.createElement(
                'li',
                {
                  className: 'tm-quark-dropdown__option ' + (option.disabled ? 'tm-quark-dropdown__option_disabled ' : '') + 'tm-quark-dropdown__option_size_' + _this4.props.optionSize + (option.value === currentValue && _this4.props.highlightSelectedOption ? ' tm-quark-dropdown__option_selected' : ''),
                  ...
                  ref: function ref(_ref7) {
                    _this4['option' + optionIndex] = _ref7;
                  },
                  key: index
                },
