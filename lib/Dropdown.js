  ...
  (0, _createClass3.default)(Dropdown, [{
    ...
    value: function renderOptions() {
      ...
      return this.props.options.filter(function (option) {
        ...
        var iconClassName = _this6.props.type === 3 && option.icon && option.icon.length > 0 ? ' icon icon-' + option.icon : '';
    ...
    value: function render() {
      ...
      var buttonIconClassName = selectedOptionIcon.length > 0 && this.props.type === 3 ? ' icon icon-' + selectedOptionIcon : '';
