  ...
  (0, _createClass3.default)(Dropdown, [{
    ...
    value: function renderOptions() {
      ...
      return this.props.options.filter(function (option) {
        ...
        var iconClassName = _this6.props.type === 3 && option.icon && option.icon.length > 0 ? ' dropdown__icon icon icon-' + option.icon : '';
        var className = 'dropdown__option' + selectedClassName + iconClassName;
