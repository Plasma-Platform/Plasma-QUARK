...
var Popup = function (_React$Component) {
  ...
  function Popup(props) {
    ...
    _this.handleCloseClick = function () {
      _this.content.classList.add('popup__content_animate_hide');
      _this.content.addEventListener('animationend', _this.hideContent);
    };

    _this.hideContent = function () {
      document.body.style.overflow = null;
      _this.content.removeEventListener('animationend', _this.hideContent);
      _this.props.onRequestClose();
    };

    _this.renderContent = function () {
      var popupClassName = 'popup' + (_this.props.className ? ' ' + _this.props.className : '');

      var contentBgClassName = ' popup__content_bg_' + _this.props.bg;
      var contentPaddingClassName = ' popup__content_padding_' + _this.props.padding;
      var contentClassName = 'popup__content popup__content_animate_show' + contentPaddingClassName + contentBgClassName;

      var closeBtnClassName = 'popup__close-btn popup__close-btn_bg_' + _this.props.bg;

      var closeCrossClassName = 'popup__close-cross popup__close-cross_bg_' + _this.props.bg;
